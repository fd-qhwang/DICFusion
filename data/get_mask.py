...
if __name__ == '__main__':
    ...
    T_path = "./datasets/MSRS/train/ir/"
    RGB_path = "./datasets/MSRS/train/vi/"

    T_file_list = sorted(os.listdir(T_path))
    RGB_file_list = sorted(os.listdir(RGB_path))

    T_map_path = "./datasets/MSRS/train/max_mask/"
    RGB_map_path = "./datasets/MSRS/train/avg_mask/"
    Fusion_map_path = "./datasets/MSRS/train/fusion_mask/"
